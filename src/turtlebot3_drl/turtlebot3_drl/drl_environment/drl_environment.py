...
class DRLEnvironment(Node):
    def __init__(self):
        ...
        self.prev_goal_x = None
        self.prev_goal_y = None
    ...
    *******************************************************************************"""
    ...
    def goal_pose_callback(self, msg):
        ...
        if self.goal_x != self.prev_goal_x or self.goal_y != self.prev_goal_y:
            print(f"new goal! x: {self.goal_x} y: {self.goal_y}")
            # Update previous goal coordinates
