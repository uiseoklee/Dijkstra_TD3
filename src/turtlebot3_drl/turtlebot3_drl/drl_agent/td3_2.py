...
class Actor(Network):
    def __init__(self, name, state_size, action_size, hidden_size):
        ...
        self.fa4 = nn.Linear(int(hidden_size / 2), int(hidden_size / 3**8))
        self.fa5 = nn.Linear(int(hidden_size / 2**8), int(hidden_size / 2**16))
        self.fa6 = nn.Linear(int(hidden_size / 2**16), action_size)
